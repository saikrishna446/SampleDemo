...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(
				System.getProperty("user.dir") + "/Pratice/src/test/resources/Reports"
						+ formater.format(calendar.getTime()) + ".html",
				true);
	}

	public void loadData() throws IOException {
		File file = new File("E:\\Pratice\\Pratice\\src\\main\\java\\com\\test\\automation\\uiAutomation\\config\\config.properties");
	...
	/* public String[][] getData(String excelName, String sheetName) { String path =
	 System.getProperty("user.dir") +
	 "/src/main/java/com/test/automation/uiAutomation/data/" + excelName; excel =
	 new Excel_Reader(path); String[][] data = excel.getDataFromSheet(sheetName,
	 excelName); return data; }*/
